...
--
-- Host: localhost:8889
-- Generation Time: Mar 10, 2019 at 10:15 PM
...
--
-- Database: `jared_hanson`
--
CREATE DATABASE IF NOT EXISTS `jared_hanson` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `jared_hanson`;
